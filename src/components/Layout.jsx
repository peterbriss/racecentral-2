...
import posterImage from '@/images/rctv.webp'
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      <p
        className={clsx('mt-2 text-base leading-7 text-slate-100', {
          'lg:line-clamp-4': false,
        })}
      >
        Longest running motorsports show, tens of millions of households,
        broadcast tv - digital tv, fun, fast, and accessible. Race results, race
        highlights, sponsor showcase, driver interviews, and team showcase.
      </p>
    </section>
  )
}
...
export function Layout({ children }) {
  return (
    <>
      <div className="bg-carbon bg-cover lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
        <div className="hidden lg:sticky lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
          <span className="font-mono text-slate-300">Hosted by</span>
          <span className="mt-6 flex font-bold text-slate-300">
            <span className="after:mt-6 after:text-slate-200 after:content-['|']">
              <Link href="https://www.linkedin.com/in/kurt-hansen-2308476/" target="_blank">
                Kurt Hansen
              </Link>
            </span>
          </span>
          <span className="mt-6 font-mono text-slate-300">Website by</span>
          <span className="mt-6 flex font-bold text-slate-300">
            <span className="after:my-6">
              <Link href="https://www.MapleCandy.Dev" target="_blank">
                Maple Candy LLC
              </Link>
            </span>
          </span>
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <div className="mt-8 text-center lg:mt-10 lg:text-left">
            <p className="text-xl font-bold text-slate-300">
              <Link href="/">
                Kurt Hansen&apos;s Race Central
              </Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-200">
              <Link className="group text-center lg:text-left text-pink-500 hover:text-pink-700 active:text-pink-900"
                href="https://tuner.bonneville.com/live/KEPN-AM"
                target="_blank"
              >
                <span className="block">Listen live on ESPN Denver (1600am)</span>
              </Link>
            </p>
          </div>
          <section className="mt-8 lg:mt-10">
            <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-slate-300 lg:not-sr-only">
              <svg aria-hidden="true" className="h-2.5 w-2.5 fill-slate-300">
                <path
                  d="M0 5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5Z"
                  className="fill-violet-300"
                />
              ...
              <span className="ml-2.5">Or Your Favorite Podcast App</span>
            </h2>
            <div className="h-px bg-gradient-to-r from-slate-200/0 via-slate-200 to-slate-200/0 lg:hidden" />
            <ul className="mt-4 flex justify-center space-x-10 text-base font-medium leading-7 text-slate-200 sm:space-x-8 lg:block lg:space-x-0 lg:space-y-4">
              <li className="flex">
                <Link
                  className="group flex items-center"
                  href="https://podcasts.apple.com/us/podcast/race-central-podcast/id1496044182"
                  target="_blank"
                >
                  <svg
                    aria-hidden="true"
                    className="h-8 w-8 fill-slate-300 group-hover:fill-slate-500"
                  >
              ...
              <li className="flex">
                <Link className="group flex items-center"
                  href="https://www.audible.com/pd/Race-Central-with-Kurt-Hansen-Full-Show-4-1-2022-Podcast/B09X2DDHCK"
                  target="_blank"
                >
                  <svg
                    aria-hidden="true"
                  ...
                  <span className="sr-only sm:hidden">Audible</span>
                  <span className="hidden sm:ml-3 sm:block">Audible</span>
                </Link>
              </li>
              <li className="flex">
                <Link className="group flex items-center"
                  href="https://open.spotify.com/show/6wB9qiZSXH3gIRTZIvkEdL"
                  target="_blank"
                >
                  <svg
                    aria-hidden="true"
              ...
              <li className="flex">
                <Link className="group flex items-center"
                  href="https://www.omnycontent.com/d/playlist/61af0f78-644a-4500-9792-a89500ea78e5/04154e08-3c85-4474-bdad-a9850133fca2/31a0d8c9-7f2e-4979-a136-a98501342dfe/podcast.rss"
                  target="_blank"
                >
                  <svg
                    aria-hidden="true"
      ...
      <div className="border-t border-slate-200 bg-carbon bg-cover py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden">
        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
          <AboutSection />
          <h2 className="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-slate-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 11 12"
          ...
          <div className="mt-2 flex text-sm font-bold leading-7 text-slate-300">
            <span>
              <Link href="https://www.linkedin.com/in/kurt-hansen-2308476/" target="_blank">
                Kurt Hansen
              </Link>
          ...
          <h2 className="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-slate-300">
            ...
            <span className="ml-2.5">Website by</span>
          </h2>
          <div className="mt-2 flex text-sm font-bold leading-7 text-slate-300">
            <span className="after:mx-6">
              <Link href="https://www.MapleCandy.Dev" target="_blank">
                Maple Candy LLC
              </Link>
            </span>
